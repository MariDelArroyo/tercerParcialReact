...
| 0:30 – 1:20 | **Una partida en el navegador** | Crear la partida (nombres), mover sobre un cristal para recolectarlo (aparece el +12⚡ en el registro), usar el botón **Reunir** si quedó un cristal bajo la nave, disparar, escudo, ver el cometa, ver barras y registro, llegar al final (ganador/empate). |
